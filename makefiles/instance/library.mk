...
ifneq ($($(THEOS_CURRENT_INSTANCE)_INSTALL_TO_THEOS),)
...
ifeq ($(THEOS_PACKAGE_SCHEME),)
	...
	$(ECHO_COPYING_LIBRARY)rsync -ra "$(THEOS_OBJ_DIR)/$(THEOS_CURRENT_INSTANCE)$(_LOCAL_LIBRARY_EXTENSION)" "$(THEOS_LIBRARY_PATH)/$(THEOS_TARGET_NAME)/$(THEOS_PACKAGE_SCHEME)"$(ECHO_END)
endif
endif
endif
endif
...
ifeq ($(THEOS_PACKAGE_SCHEME),)
	...
	$(ECHO_NOTHING)mkdir -p "$(THEOS_LIBRARY_PATH)/$(THEOS_TARGET_NAME)/$(THEOS_PACKAGE_SCHEME)/"$(ECHO_END)
	$(ECHO_COPYING_LIBRARY)rsync -ra "$(THEOS_OBJ_DIR)/$(THEOS_CURRENT_INSTANCE)$(_LOCAL_ARCHIVE_EXTENSION)" "$(THEOS_LIBRARY_PATH)/$(THEOS_TARGET_NAME)/$(THEOS_PACKAGE_SCHEME)"$(ECHO_END)
endif
endif
endif
endif
