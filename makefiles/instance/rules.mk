...
_THEOS_INTERNAL_CFLAGS += -D THEOS_PACKAGE_SCHEME_$(shell echo $(or $(THEOS_PACKAGE_SCHEME),rootful) | tr a-z A-Z)="1"
...
ALL_CCFLAGS_STRIPED = $(filter-out -std=%,$(ALL_CCFLAGS))
ALL_OBJCCFLAGS_STRIPED = $(filter-out -std=%,$(ALL_OBJCCFLAGS))
ALL_SWIFTFLAGS = $(_THEOS_INTERNAL_SWIFTCOLORFLAGS) $(foreach flag,$(ALL_CFLAGS) $(ALL_CCFLAGS_STRIPED) $(ALL_OBJCFLAGS) $(ALL_OBJCCFLAGS_STRIPED),-Xcc $(flag)) $(_THEOS_INTERNAL_SWIFTFLAGS) $(_THEOS_TARGET_SWIFTFLAGS) $(ADDITIONAL_SWIFTFLAGS) $(call __schema_var_all,$(THEOS_CURRENT_INSTANCE)_,SWIFTFLAGS) $(call __schema_var_all,,SWIFTFLAGS)
